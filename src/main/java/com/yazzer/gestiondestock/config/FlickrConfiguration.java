package com.yazzer.gestiondestock.config;
...
//Configurer et générer Api KEY, nous le configurons une seule fois pour générer Api KEY
    /*@Bean
    public Flickr getFlickr () throws InterruptedException, ExecutionException, IOException, FlickrException {
        ...
        System.out.println("-----------------------------------------");
        System.out.println(auth.getToken()); //notre application Key
        System.out.println(auth.getTokenSecret()); //notre application Secret
